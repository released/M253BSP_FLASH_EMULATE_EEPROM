...
; * @file     startup_M253.s
; * @version  V0.10
; * @brief    M253 Series Startup Source File
; *
...
__Vectors       DCD     __initial_sp               ;     Top of Stack
                ...
                DCD     CANFD0_IRQ0_IRQHandler     ; 24
                DCD     CANFD0_IRQ1_IRQHandler     ; 25
                ...
                DCD     UART4_IRQHandler           ; 51
                DCD     DEFAULT_IRQHandler         ; 52
                DCD     USBD_IRQHandler            ; 53
                DCD     DEFAULT_IRQHandler         ; 54
                DCD     DEFAULT_IRQHandler         ; 55
                DCD     DEFAULT_IRQHandler         ; 56
                DCD     DEFAULT_IRQHandler         ; 57
                DCD     DEFAULT_IRQHandler         ; 58
                DCD     DEFAULT_IRQHandler         ; 59
                DCD     DEFAULT_IRQHandler         ; 60
...
Default_Handler PROC
               ...
               ;EXPORT  DEFAULT_IRQHandler        [WEAK] ; 3
                EXPORT  CLKFAIL_IRQHandler        [WEAK] ; 4
               ;EXPORT  DEFAULT_IRQHandler        [WEAK] ; 5
                EXPORT  RTC_IRQHandler            [WEAK] ; 6
               ;EXPORT  DEFAULT_IRQHandler        [WEAK] ; 7
               ...
               ;EXPORT  DEFAULT_IRQHandler        [WEAK] ; 22
                EXPORT  SPI0_IRQHandler           [WEAK] ; 23
                EXPORT  CANFD0_IRQ0_IRQHandler    [WEAK] ; 24
                EXPORT  CANFD0_IRQ1_IRQHandler    [WEAK] ; 25
               ;EXPORT  DEFAULT_IRQHandler        [WEAK] ; 26
               ;EXPORT  DEFAULT_IRQHandler        [WEAK] ; 27
               ;EXPORT  DEFAULT_IRQHandler        [WEAK] ; 28
               ;EXPORT  DEFAULT_IRQHandler        [WEAK] ; 29
               ;EXPORT  DEFAULT_IRQHandler        [WEAK] ; 30
               ;EXPORT  DEFAULT_IRQHandler        [WEAK] ; 31
               ...
               ;EXPORT  DEFAULT_IRQHandler        [WEAK] ; 44
                ...
                EXPORT  UART4_IRQHandler          [WEAK] ; 51
               ;EXPORT  DEFAULT_IRQHandler        [WEAK] ; 52
                EXPORT  USBD_IRQHandler           [WEAK] ; 53
               ;EXPORT  DEFAULT_IRQHandler        [WEAK] ; 54
               ;EXPORT  DEFAULT_IRQHandler        [WEAK] ; 55
               ;EXPORT  DEFAULT_IRQHandler        [WEAK] ; 56
               ;EXPORT  DEFAULT_IRQHandler        [WEAK] ; 57
               ;EXPORT  DEFAULT_IRQHandler        [WEAK] ; 58
               ;EXPORT  DEFAULT_IRQHandler        [WEAK] ; 59
               ;EXPORT  DEFAULT_IRQHandler        [WEAK] ; 60
               ;EXPORT  DEFAULT_IRQHandler        [WEAK] ; 61
               ;EXPORT  DEFAULT_IRQHandler        [WEAK] ; 62
               ;EXPORT  DEFAULT_IRQHandler        [WEAK] ; 63
...
PWRWU_IRQHandler            ; 2
;DEFAULT_IRQHandler         ; 3
CLKFAIL_IRQHandler          ; 4
;DEFAULT_IRQHandler         ; 5
RTC_IRQHandler              ; 6
;DEFAULT_IRQHandler         ; 7
WDT_IRQHandler              ; 8
WWDT_IRQHandler             ; 9
EINT0_IRQHandler            ; 10
EINT1_IRQHandler            ; 11
...
GPE_IRQHandler              ; 20
GPF_IRQHandler              ; 21
;DEFAULT_IRQHandler         ; 22
SPI0_IRQHandler             ; 23
CANFD0_IRQ0_IRQHandler      ; 24
CANFD0_IRQ1_IRQHandler      ; 25
;DEFAULT_IRQHandler         ; 26
;DEFAULT_IRQHandler         ; 27
;DEFAULT_IRQHandler         ; 28
;DEFAULT_IRQHandler         ; 29
;DEFAULT_IRQHandler         ; 30
;DEFAULT_IRQHandler         ; 31
TMR0_IRQHandler             ; 32
TMR1_IRQHandler             ; 33
TMR2_IRQHandler             ; 34
TMR3_IRQHandler             ; 35
...
USCI0_IRQHandler            ; 50
UART4_IRQHandler            ; 51
;DEFAULT_IRQHandler         ; 52
USBD_IRQHandler             ; 53
;DEFAULT_IRQHandler         ; 54
;DEFAULT_IRQHandler         ; 55
;DEFAULT_IRQHandler         ; 56
;DEFAULT_IRQHandler         ; 57
;DEFAULT_IRQHandler         ; 58
;DEFAULT_IRQHandler         ; 59
;DEFAULT_IRQHandler         ; 60
;DEFAULT_IRQHandler         ; 61
;DEFAULT_IRQHandler         ; 62
;DEFAULT_IRQHandler         ; 63
